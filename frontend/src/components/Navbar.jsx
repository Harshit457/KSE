    ...
    <div>
      <div className="topdiv flex justify-between pl-14 pr-10 bg-cyan-800">
        ...
        <div className="flex  justify-center items-center">
          <a
            href=""
            className="ml-3 font-semibold hover:bg-blue-800 hover:text-white flex items-center rounded-2xl justify-center w-24 mr-3 h-9 text-xl"
          >
            Home
          </a>
          <a
            href="Signin"
            className="ml-1 font-semibold hover:bg-blue-800 hover:text-white flex items-center rounded-2xl justify-center w-24 mr-3 h-9 text-xl"
          >
            Sign in
          </a>
          <a
