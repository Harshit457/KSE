  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900">
      <div className="relative bg-gray-800 p-8 rounded-lg shadow-lg w-96">
        ...
        <button
          onClick={verify}
          className="w-full bg-white text-black font-bold py-3 rounded-md hover:bg-gray-300 transition duration-300"
        >
          Log In
        </button>
        ...
        <div className="flex justify-between mt-6">
          ...
          <a href="Signup" className="flex z-50  text-gray-200">
            Signup
          </a>
        </div>
      </div>
