  ...
  return (
    <div className="h-full w-full overflow-hidden">
        ...
        <div className=" bg-zinc-900 h-screen flex justify-around  w-screen    ">
          <div className=" pt-28  ">
            ...
            <div className="font-bold text-5xl mt-4 ">
              Unlock New Skills, Share Your
            </div>
            <div className="font-bold text-5xl mt-3 ">Expertise</div>
            <div className="font-semibold  text-2xl mt-12 ">
              Learn from others,teach what you know. <br /> Join a community of
              learners and experts <br /> exchanging Knowledge.
            </div>
            <br />
            <div>
              <a
                href="Signup"
                className="h-12  hover:bg-blue-950  hover:text-white flex justify-center items-center w-32 text-2xl text-black font-bold bg-slate-100 rounded-2xl"
              >
                Join us
              </a>
            </div>
      ...
      <div className=" pt-20 bg-cyan-900 ">
        <div className="items-center flex justify-center text-5xl text-blue-300 font-semibold">
          Our Best Services
        </div>{" "}
        <br />
        <br />
        ...
        <div className="flex justify-evenly ">
          <Card
            ...
            description={
              "Build websites that inspire! Share your web development skills and learn from experts in real-time."
            }
          ></Card>
          <Card
            heading={"App Development"}
            description={
              "Build applications that inspire! Share your android development skills and learn from experts in real-time."
            }
          ></Card>
          <Card
            heading={"Machine Learning"}
            description={
              "Build Machine that inspire! Share your machine learning skills and learn from experts in real-time."
            }
          ></Card>
          <Card
            heading={"UI/UX"}
            description={
              "Build UI that inspire! Share your UI/UX skills and learn from experts in real-time."
            }
          ></Card>
        </div>
        <br />
        ...
        <footer className="bg-stone-900 border-t-2 border-gray-600 text-gray-300 p-8">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <br />
              <p className="mt-2 text-3xl">Enhance your skills</p>
              <br />
              {/* Social Media Icons */}
              <div className="flex mt-4 space-x-3">
                <a href="#" aria-label="LinkedIn">
                  <svg
                    className="w-6 h-6 fill-current text-gray-500 hover:text-blue-600"
                ...
                <a href="#" aria-label="Instagram">
                  <svg
                    className="w-6 h-6 fill-current text-gray-500 hover:text-pink-500"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                  >
                ...
                <a href="#" aria-label="Twitter">
                  <svg
                    className="w-6 h-6 fill-current text-gray-500 hover:text-blue-400"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                  >
                ...
                <a href="#" aria-label="Facebook">
                  <svg
                    className="w-6 h-6 fill-current text-gray-500 hover:text-blue-700"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                  >
            ...
            {/* Resources Section */}
            <div>
              <h2 className="text-4xl font-bold text-gray-300">Resources</h2>
              <br />
